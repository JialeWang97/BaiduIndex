# -*- coding: utf-8 -*-
"""
Created on Tue Feb 26 21:41:12 2019
...
def writeIntoCsvFile(result,filename):
    arr=[]
    with open('baiduindex'+ filename + '抑郁_焦虑' +'.csv','w',newline='') as csvfile:
        writer = csv.writer(csvfile)
        writer.writerow(["城市","抑郁","焦虑"])
...
def getindex(keywords, cities):
    ...
    browser.find_element_by_xpath("html/body/div[11]/div[1]/div[2]/div[1]/div[1]/div[1]/span[1]/button[1]").click()
    #月份默认为1月，设置日为1号
    browser.find_element_by_xpath("//button[contains(@aria-label,'2011年1月3日')]").click()
    #终止时间
    ...
    for i in range(10):
        ...
        time.sleep(0.1)
    #日设置31号  
    browser.find_element_by_xpath("//button[contains(@aria-label,'2011年12月31日')]").click()
    #点击确定
    ...
    for word in keywords:
        ...
        #每一个关键字休息10秒 
        time.sleep(10)                 
    writeIntoCsvFile(result,str(2011))          
